...
func main() {
	...
	readerInterval := flag.Int("reader-interval", 600, "Interval in seconds to read subscriptions for updates")
	readerFeeds := flag.Int("reader-feeds", 100, "How many feeds to read between intervals")
	flag.Parse()
